...
public class EnchantmentCompatibilityMixin {
    ...
    private static boolean hookIsCompatibleWith(boolean original, Holder<Enchantment> first, Holder<Enchantment> second) {
        Enchantment selfEnchantment = first.value();
        Enchantment otherEnchantment = second.value();

        // 获取两个附魔的ID
        ResourceLocation selfId = EnchantmentRegistry.getId(selfEnchantment);
        ResourceLocation otherId = EnchantmentRegistry.getId(otherEnchantment);
    ...
    // 辅助方法
    private static boolean isProtectionEnchantment(ResourceLocation id) {
    ...
    private static boolean isWeaponDamageEnchantment(ResourceLocation id) {
        String idStr = id.toString();
    ...
    private static boolean isAxeExpansionEnchantment(ResourceLocation id) {
        String idStr = id.toString();
        return idStr.equals("minecraft:fire_aspect") ||
               idStr.equals("minecraft:looting");
    }

    private static boolean isAllowedAxeEnchantment(ResourceLocation id) {
        // 允许斧头附魔的列表
        String idStr = id.toString();
    ...
    private static boolean isBowEnchantment(ResourceLocation id) {
        String idStr = id.toString();
    ...
    private static boolean isTridentExpansionEnchantment(ResourceLocation id) {
        String idStr = id.toString();
        return idStr.equals("minecraft:sharpness") ||
               idStr.equals("minecraft:smite") ||
               idStr.equals("minecraft:bane_of_arthropods") ||
    ...
    public boolean hookCanEnchant(boolean original, ItemStack stack) {
        Enchantment self = (Enchantment) (Object) this;
        ResourceLocation selfId = EnchantmentRegistry.getId(self);
